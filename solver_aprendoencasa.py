...
class HomeworkSolver:
    ...
    def extract_spanish_questions_from_text(self, text, file_name):
    ...
    def get_homework_result(self): # The Gold of The program
        for doc in self.docs_questions_answers:
            print("Document : " + doc + "\n")
            for question in self.docs_questions_answers[doc]:
                ...
                for content in self.docs_questions_answers[doc][question].split(":"):
                    print(content)
                print("\n\n")
                # # print(self.docs_questions_answers[doc][question])
                # print("\n\n")
    ...
    def return_answers_by_url(self, email, password, homework_url, sections_to_click_through):
        ...
        if sections_to_click_through != []:
            ...
            self.week_sections = self.browser.find_element_by_class_name("resources__week__weeks").find_elements_by_tag_name("button")
